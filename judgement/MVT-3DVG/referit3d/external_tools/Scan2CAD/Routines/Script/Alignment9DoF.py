...
if __name__ == "__main__":
    ...
    for k, v in collect_results.items():
        ...
        filename_vox_scan = os.path.abspath(
    ...
    for k, v in scenes.items():
        ...
        q = [1, 0, 0, 0]
        s = [1, 1, 1]
        filename_scan_mesh = os.path.abspath(
            params["scannet"] + "/" + id_scan + "/" + id_scan + "_vh_clean_2.ply"
        )

        scan = {
            "filename": filename_scan_mesh,
            "type": "scannet",
            "trs": {"trans": t, "rot": q, "scale": s},
        }
        ...
        for item in v:
            ...
            s = item[10:13]
            # -> cad
            filename_cad_mesh = os.path.abspath(
                params["shapenet"] + catid_cad + "/" + id_cad + "/models_old/model_normalized.obj"
            )
            cargo["meshes"].append(
                {
