...
from referit3d.models.backbone.word_embeddings import (
    load_glove_pretrained_embedding,
    make_pretrained_embedding,
)
...
try:
    ...
    PointNetPP = None
    msg = colored(
        "Pnet++ is not found. Hence you cannot run all models. Install it via "
        "external_tools (see README.txt there).",
        "red",
    )
    print(msg)
