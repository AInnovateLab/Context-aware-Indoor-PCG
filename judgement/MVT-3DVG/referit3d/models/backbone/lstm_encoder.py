...
class LSTMEncoder(nn.Module):
    ...
    def __init__(
        ...
        self.rnn = nn.LSTM(
            input_size=n_input, hidden_size=n_hidden, bidirectional=bidirectional, batch_first=True
        )
    ...
    def __call__(self, tokens, grounding=None, len_of_sequence=None):
        ...
        x_packed = pack_padded_sequence(
            w_emb, len_of_sequence, enforce_sorted=False, batch_first=True
        )
