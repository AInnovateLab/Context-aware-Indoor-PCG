import pandas as pd
from data.utils import read_dict_from_json
...
def load_scan2cad_meta_data(scan2CAD_meta_file):
    ...
    """
    scan2CAD_temp = read_dict_from_json(scan2CAD_meta_file)
...
def register_scan2cad_bboxes(all_scans, scan2CAD, bad_mappings_file=None):
    ...
    if bad_mappings_file is not None:
        bad_mappings = read_dict_from_json(bad_mappings_file)
    else:
        bad_mappings = None
    ...
    for scan in all_scans:
        ...
        for o in scan.three_d_objects:
            ...
            if key in scan2CAD:
                ...
                o.set_object_aligned_bbox(*o_info["obj_bbox"], rot=rot)
                registered += 1
