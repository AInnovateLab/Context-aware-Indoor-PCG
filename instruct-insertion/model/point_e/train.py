...
def main():
    ...
    p.add_argument(
        "--save-root", type=str, default="./save_path", help="save root for logger and ckpt"
    )
    p.add_argument(
        "--log-dir", type=str, default="./save_path", help="save root for logger and ckpt"
    )
    p.add_argument("--cond", type=str, default="texts", help="condition type")
    args = p.parse_args()
