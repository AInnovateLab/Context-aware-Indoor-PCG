...
def crop_from_volume(s0, x, y, z):
    ...
    sdf0 = s0.sdf.ravel()
    pdf0 = s0.pdf.ravel()
    CropSample.crop_sample(
        x, y, z, [s0.dimx, s0.dimy, s0.dimz], [31, 31, 62], s0.res, sdf0, pdf0, sdf, pdf
    )
...
def save_net1_prediction(
    batch_size, rootdir, sdf0, sdf1, target, prediction, basename_save, grid2world0, grid2world1
):
