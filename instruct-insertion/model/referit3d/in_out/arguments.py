...
from ..utils import create_dir, str2bool
...
def parse_arguments(notebook_options=None):
    ...
    parser.add_argument(
        "--log-dir",
        default="/mnt/petrelfs/zhaolin/projects/3d/MVT-3DVG/output",
        type=str,
    ...
    parser.add_argument(
        "--bert-pretrain-path",
        type=str,
        default="/mnt/petrelfs/zhaolin/files/Asrclin/data/scannet/BertModels",
    )
