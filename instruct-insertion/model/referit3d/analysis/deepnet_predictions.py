...
def analyze_predictions(
    ...
    for seed in test_seeds:
        ...
        net_stats = detailed_predictions_on_dataset(
            model, d_loader, args=args, device=device, FOR_VISUALIZATION=True, tokenizer=tokenizer
        )
    ...
    acc_df = pd.DataFrame(
        {
            ...
            "easy": easy_acc,
            "v-dep": view_dep_acc,
            "v-indep": view_indep_acc,
            "all": all_accuracy,
            "among-true": among_true_acc,
        }
    )
